        ...
        <>
            ...
            <div className="card">
                ...
                <div className="member">
                    <Member pfp="/dv.png" name="DV"/>
                    <Member pfp="/dhalia.jpg" name="Dahlia"/>
                    <Member pfp="/theresa.png" name="Theresa"/>
                    <Member pfp="/ben.jpg" name="Ben"/>
                    <Member pfp="/vicky.jpg" name="Vicky"/>
                    <Member pfp="/shawyan.jpg" name="Shawyan"/>
                    <Member pfp="/sparsh.png" name="Sparsh"/>
            ...
            <div className='Statements'>
                ...
                <Statement pfp="/theresa.png" name="Theresa" statement="Fostering curiosity, ingenuity, and creativity in students 
